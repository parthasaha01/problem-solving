    ...
    for(int ks=1; ks<=tt; ks++)
    {
        ...
        if(fabs(x-0.0)<=eps && fabs(L-y)<=eps)
        {
            ...
            for(int i=1; i<=1000; i++)
            {
                 ...
                 double area = triangleArea(0.0,0.0,x,y,mx,my);
                 if(area>half_area){
                    qx = mx; qy = my;
                 }
                 else{
        ...
        if(fabs(x-0.0)<=eps)
        {
            ...
            u1 = mx;
            v1 = my;
            a1 = triangleArea(0.0,0.0,x,y,u1,v1);
            d1 = fabs(half_area-a1);
            ...
            for(int i=1; i<=1000; i++)
            {
                 ...
                 double area = triangleArea(0.0,L,x,y,mx,my);
                 if(area>half_area){
                    qx = mx; qy = my;
                 }
                 else{
            ...
            u2 = mx;
            v2 = my;
            a2 = triangleArea(0.0,L,x,y,u2,v2);
            d2 = fabs(half_area-a2);
        ...
        else if(fabs(y-0.0)<=eps)
        {
            ...
            for(int i=1; i<=1000; i++)
            {
                 ...
                 double area = triangleArea(L,0.0,x,y,mx,my);
                 if(area>half_area){
                    px = mx; py = my;
                 }
                 else{
            ...
            u2 = mx;
            v2 = my;
            a2 = triangleArea(L,0.0,x,y,u2,v2);
            d2 = fabs(half_area-a2);
