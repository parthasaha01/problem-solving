...
We want to know how many distinct substring of S which is palindrome.
*/
#include<bits/stdc++.h>
using namespace std;
...
struct Node{
    ...
    /// length -> stores length of substring
    /// suffixLink -> stores the Maximum Palindromic Suffix Node for the current Node
...
struct PalTree{
    ...
    Node root1;
    Node root2;
    /// root1 -> is a pallindrome of -1 length to accept odd length pallindrome
    /// (“a”, “c”, “d” is accepted by this node,
    /// in other words single character pallindrome are accepted by this )

    /// root2 -> is a pallindrome of 0 length to accept even length pallindrome
    /// (“aa”, “bb”,”abba” is accepted by this)
    char s[MAXN];   // String
    int curNode,ptr;
    ...
    /// If addition of s[pos] form a new pallindrome
    /// different from the previously present,
    ...
    bool addLetter(int pos)
    {
        ...
        /*  search for Node X such that s[pos] X s[pos]
            is maximum palindrome ending at position pos.
            iterate down the suffix link of currNode to
            find X and X is also Palindrome
        */
        ...
        */
        ...
        /// linking current Nodes suffix link with s[pos]+Y+s[pos]
        /// Giving Suffix suffixLink
